...
class SignupEmail extends EmailTemplate
{
    protected $_organisation = null, $_aboveLinkContent = null, $_belowLinkContent = null, $_link = null;

    public function __construct($to, $aboveLinkContent, $belowLinkContent, $link, $sourceOrganisation, $cc = null)
    {
        ...
        parent::__construct(
            ...
            _g('Welcome to Apprecie - Login Below'),
            $cc
        );
    }
    ...
    public function build()
    {
        ...
        $contentTokens =
            [
                ...
                'link' => $this->_link,
                'linkText' => _g('Click here to Sign Up'),
