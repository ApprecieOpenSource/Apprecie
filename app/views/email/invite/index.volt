<div style="font-family: {{font}}; font-size: 14px;color: {{fontColor}};">
        ...
        <td style="display: block;max-width: 600px;margin: 0 auto;clear: both;background-color: #F3F3F4;">
            <div style="max-width: 600px;margin: 0 auto;padding: 10px;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td>
                            <div style="font-weight: bold;font-style: italic;padding: 10px 20px;font-family: {{font}};font-size: 16px;color: {{fontColor}};"><?= _g('Your Invitation'); ?></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<table align="center" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td></td>
        <td style="display: block;max-width: 600px;margin: 0 auto;clear: both;">
                <div style="margin: 0 auto;max-width: 600px;padding: 10px 0;font-size: 10px;text-align: center;">
