        ...
        <td style="display: block;max-width: 600px;margin: 0 auto;clear: both;background-color: #F3F3F4;">
            <div style="padding: 10px;max-width: 600px;margin: 0 auto;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td>
                            <div style="background-color: #fff;color: {{fontColor}};border-top: 4px solid #E7EAEC;padding: 20px 20px 10px 20px;font-family: {{font}};font-size: 14px;">
                                {aboveLinkContent}
                            </div>
                            ...
                            <div style="background-color: #fff;color: {{fontColor}};padding: 20px;font-family: {{font}};font-size: 14px;">
                                {belowLinkContent}
                            </div>
                        </td>
                    </tr>
