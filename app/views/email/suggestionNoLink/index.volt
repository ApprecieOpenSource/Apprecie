                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="padding: 10px 20px;font-family: {{font}};font-size: 14px;color: {{fontColor}};">
                                {eventDescriptionFull}
                            </div>
                            <div style="padding: 10px 20px;font-family: {{font}};font-size: 14px;color: {{fontColor}};">
                                <p style="font-weight: bold;">What is Included</p>
                                {eventWhatIsIncluded}
                            </div>
                            <div style="padding: 10px 20px;font-family: {{font}};font-size: 14px;color: {{fontColor}};">
                                <p style="font-weight: bold;">Attendance Terms</p>
                                {eventAttendanceTerms}
                            </div>
                        </td>
                    </tr>
                    </tbody>
