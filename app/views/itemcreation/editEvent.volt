...
?>
<script src="/js/validation/items/confirmed-edit.js"></script>
    ...
    <div class="col-sm-8">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <span class="pull-right" style="font-weight: 600"><?= _g('EDIT - CONFIRMED EVENT'); ?></span>
            </div>
            <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="confirmed-bookingstart" name="confirmed-bookingstart" value="<?= date('d/m/Y',strtotime($this->view->event->getBookingStartDate())); ?>" class="form-control" style="max-width: 120px; display: inline" placeholder="DD/MM/YYYY">
                    </div>
                </div>
                <div class="form-group">
                    <label for="title" class="col-sm-3 control-label">*&nbsp;Booking End Date</label>
                    <div class="col-sm-9">
                        <input type="text" id="confirmed-bookingend" name="confirmed-bookingend" value="<?= date('d/m/Y',strtotime($this->view->event->getBookingEndDate())); ?>" class="form-control" style="max-width: 120px; display: inline" placeholder="DD/MM/YYYY">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" id="confirmed-startdate" name="confirmed-startdate" value="<?= date('d/m/Y',strtotime($this->view->event->getStartDateTime())); ?>" class="form-control" style="max-width: 120px; display: inline" placeholder="DD/MM/YYYY">
                            <input type="text" value="<?= date('H:i',strtotime($this->view->event->getStartDateTime())); ?>" id="confirmed-starttime" name="confirmed-starttime" class="form-control" style="max-width: 120px; display: inline" placeholder="HH:MM">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            <input type="text" id="confirmed-enddate" name="confirmed-enddate" value="<?= date('d/m/Y',strtotime($this->view->event->getEndDateTime())); ?>" class="form-control" style="max-width: 120px; display: inline" placeholder="DD/MM/YYYY">
                            <input type="text" id="confirmed-endtime" name="confirmed-endtime" value="<?= date('H:i',strtotime($this->view->event->getEndDateTime())); ?>" class="form-control" style="max-width: 120px; display: inline" placeholder="HH:MM">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-sm-8">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <label for="max-units" class="col-sm-3 control-label">*&nbsp;Maximum Packages</label>
                    <div class="col-sm-4">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <?php if(Organisation::getActiveUsersOrganisation()->getIsAffiliateSupplierOf()): ?>
                    <input type="radio" id="publishstate" class="publish-option" name="publishstate" value="parent"/><label class="publish-option" style="font-weight: normal; margin-left: 5px;">Publish to Parent Organisation</label><br/>
                <?php else: ?>
                    <?php
                    ...
                    switch($user->getActiveRole()->getName()){
                        case "Manager":
                            ?>
                            <input type="radio" id="publishstate" class="publish-option" name="publishstate" value="organisation"/><label class="publish-option" style="font-weight: normal; margin-left: 5px;">Publish to this Organisation</label><br/>
                            <?php
                            break;
                        case "Internal":
                            ?>
                        ...
                        case "ApprecieSupplier":
                            ?>
                            <input type="radio" id="publishstate" class="publish-option" name="publishstate" value="curation"/><label class="publish-option" style="font-weight: normal; margin-left: 5px;">Send to Apprecie for curation</label><br/>
                            <?php
                            break;
...
<div class="row step" id="step-9">
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="panel-footer" style="height:55px;"> <a href="/mycontent/events" class="btn btn-primary pull-right">Go to My Events</a></div>
        </div>
    </div>
</div>
</div>
