...
<?php $this->partial("partials/jparts/compliance"); ?>
<script>
    var report=null;
    $(document).ready(function(){
        ...
        report=new RoiMyEventsReport('AjaxCompliance');
    })

    function fetchReport(){
        var template = $.templates("#compliance");
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <th class="roi-column" id="start-date-column">
                            <span class="table-order-btn" onclick="orderReport('desc','reference')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','reference')"><i class="fa fa-caret-up"></i></span>
                            Reference
                        </th>
                        <th class="roi-column" id="name-column">
                            <span class="table-order-btn" style="" onclick="orderReport('desc','firstname')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','firstname')"><i class="fa fa-caret-up"></i></span>
                            First Name
                        </th>
                        <th class="roi-column" id="start-date-column">
                            <span class="table-order-btn" onclick="orderReport('desc','lastname')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','lastname')"><i class="fa fa-caret-up"></i></span>
                            Last Name
                        </th>
                        <th class="roi-column" id="start-date-column">
                            <span class="table-order-btn" onclick="orderReport('desc','emailaddress')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','emailaddress')"><i class="fa fa-caret-up"></i></span>
                            Email Address
                        </th>
                        <th class="roi-column" id="start-date-column">
                            <span class="table-order-btn" onclick="orderReport('desc','owner')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','owner')"><i class="fa fa-caret-up"></i></span>
                            Owner
                        </th>
                        <th class="roi-column" id="start-date-column">
                        ...
                        <th class="roi-column">
                            <span class="table-order-btn" onclick="orderReport('desc','gifts')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','gifts')"><i class="fa fa-caret-up"></i></span>
                            Gifts
                        </th>
                        <th class="roi-column">
                            <span class="table-order-btn" onclick="orderReport('desc','engagement')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','engagement')"><i class="fa fa-caret-up"></i></span>
                            Engagement
                        </th>
                    </tr>
                    </thead>
