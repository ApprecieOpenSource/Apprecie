...
<?php $this->partial("partials/jparts/roimitem"); ?>
<script>
    var report=null;
    $(document).ready(function(){
        ...
        report=new RoiMyEventsReport('AjaxMyEvents');
    })

    function fetchReport(){
        var template = $.templates("#roimitem");
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th class="roi-column" id="start-date-column">
                            <span class="table-order-btn" onclick="orderReport('desc','startDateTimeStamp')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','startDateTimeStamp')"><i class="fa fa-caret-up"></i></span>
                            Start Date
                        </th>
                        <th class="roi-column">
                        ...
                        <th class="roi-column">
                            <span class="table-order-btn" onclick="orderReport('desc','type')"><i class="fa fa-caret-down"></i></span>
                            <span class="table-order-btn" onclick="orderReport('asc','type')"><i class="fa fa-caret-up"></i></span>
                            Type
                        </th>
                        <th class="roi-column">
