...
<div style="margin-left:-15px; margin-right:-15px; position:relative;    padding-bottom: 15px; background-image: url('<?= Assets::getItemBannerImage($this->view->event->getItem()->getItemId());?>')">
    <a class="btn btn-default pull-right" href="/pdf/rsvp/<?= $this->view->event->getItemId(); ?>/<?= $this->view->hash; ?>" style="margin-top: 10px; margin-right: 10px;"><i class="fa fa-file-pdf-o"></i> Download Brochure</a>
...
<div class="row" style="margin-top: 15px;">
    <div class="col-sm-8" id="col2" style="margin-bottom: 15px;">
        ...
        <p><a href="#" data-toggle="modal" data-target="#attendance-terms-modal">Attendance Terms</a></p>
        <h2>Media Gallery</h2>
