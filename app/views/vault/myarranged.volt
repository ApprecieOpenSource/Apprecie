...
<div class="row">
    <div class="col-sm-12">
        ...
        <?php if($this->view->event->getItem()->getByArrangementSource()->getState() == 'approved' && \Apprecie\Library\Acl\AccessControl::userCanViewItem($this->view->user, $this->view->event->getSourceByArrangement(), null)): ?>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <p>
            Request to
            <?php
                $requestor = User::resolve($this->view->event->getCreatedBy());
             ...
             ?>
            from <?= $this->view->event->getOrganisation()->getOrganisationName(); ?> on <?= date('d-m-Y H:i:s',strtotime($this->view->event->getDateCreated())); ?><br/>
            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-sm-12 details">
                        ...
                        <p>
                            Number of packages: <?= $this->view->event->getMaxUnits(); ?>
                        </p>
                    </div>
                </div>
            </div>
