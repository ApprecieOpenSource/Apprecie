...
<script>
    ...
    function addInterest(key){
        ...
        if($.inArray(interest.interestId,selectedArray)==-1){
            ...
            selected.append('<div class="interest-picker-selected" id="selected-interest-'+interest.interestId+'" onclick="removeInterest('+interest.interestId+','+key+');">'+interest.interest+'<span class="interest-picker-plus"><i class="fa fa-minus"></i></span></div>');
