...
<script src="/js/compiled/public/js/raw/widgets/createuser/withemail.min.js"></script>
<script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><?= _g('Please provide a First Name and a Last Name. Alternatively you can use a Reference Code instead. You must also provide a valid email address.'); ?></p>
