...
<script src="/js/compiled/public/js/raw/widgets/createuser/withoptionalemail.min.js"></script>
<script>
    var refreshOnSuccess = <?= $this->view->refreshOnSuccess ? 'true' : 'false'; ?>;
    var portalId = <?= $this->view->portalId; ?>;
</script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><?= _g('Please provide a First Name and a Last Name. Alternatively you can use a Reference Code instead. You can optionally provide a valid email address if you wish to email this user via our system.'); ?></p>
