...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var container = document.getElementById('organising-timeline');
...
<div class="ibox float-e-margins" style="position: relative;">
    <div class="ibox-title">
        <h5>Upcoming Events You Are Organising (28 Days)</h5>
    </div>
    <div class="ibox-content">
        <div id="organising-timeline" style="width: 100%; height: <?php if(count($this->view->activeItems)==0){echo '50';} else {echo 58*count($this->view->activeItems);}; ?>px">
