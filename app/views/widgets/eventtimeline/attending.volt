...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var container = document.getElementById('attending-timeline');
...
<div class="ibox float-e-margins" style="position: relative;">
    <div class="ibox-title">
        <h5>Upcoming Events You Are Attending (28 Days)</h5>
    </div>
    <div class="ibox-content">
        <div id="attending-timeline" style="width: 100%; height: <?php if(count($this->view->activeItems)==0){echo '50';} else {echo 58*count($this->view->activeItems);}; ?>px">
