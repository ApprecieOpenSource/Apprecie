    ...
    <div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?= _g('The Vault'); ?> <span class="caret"></span></a>
                ...
                <li class="dropdown <?php if($this->view->getControllerName()=="eventmanagement" || $this->view->getControllerName()=="mycontent" || $this->view->getControllerName()=="itemcreation"){echo 'active';} ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?= _g('Event Management'); ?> &nbsp; <span class="badge"><?= ItemApproval::getNeedApprovalCountForOrg(); ?> </span> <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/mycontent/events"><?= _g('My Confirmed Events'); ?>&nbsp; <span class="badge"><?= ItemApproval::getNeedApprovalCountForOrg(null, true, false); ?> </span></a></li>
                        <li><a href="/mycontent/arranged"><?= _g('My By Arrangement Events'); ?>&nbsp; <span class="badge"><?= ItemApproval::getNeedApprovalCountForOrg(null, false, true); ?> </span></a></li>
                ...
                <li class="dropdown <?php if($this->view->getControllerName()=="roi"){echo 'active';} ?>">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/roi/compliance"><?= _g('Compliance'); ?></a></li>
                    </ul>
                </li>
            </ul>
