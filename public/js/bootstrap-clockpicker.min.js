(function(){function r(a){return(10>a?"0":"")+a}function F(a){var b=++G+"";return a?a+b:b}function d(a,b){function e(a,c){var e=v.offset(),f=/^touch/.test(a.type),k=e.left+100,h=e.top+100,g=(f?a.originalEvent.touches[0]:a).pageX-k,d=(f?a.originalEvent.touches[0]:a).pageY-h,e=Math.sqrt(g*g+d*d),l=!1;if(!c||!(67>e||93<e)){a.preventDefault();var m=setTimeout(function(){y.addClass("clockpicker-moving")},200);w&&v.append(n.canvas);n.setHand(g,d,!c,!0);q.off(z).on(z,function(a){a.preventDefault();var b=
...
v=f.find(".clockpicker-plate"),h=f.find(".clockpicker-hours"),g=f.find(".clockpicker-minutes"),m=f.find(".clockpicker-am-pm-block"),c="INPUT"===a.prop("tagName"),k=c?a:a.find("input"),d=a.find(".input-group-addon"),n=this;this.id=F("cp");this.element=a;this.options=b;this.isShown=this.isAppended=!1;this.currentView="hours";this.isInput=c;this.input=k;this.addon=d;this.popover=f;this.plate=v;this.hoursView=h;this.minutesView=g;this.amPmBlock=m;this.spanHours=f.find(".clockpicker-span-hours");this.spanMinutes=
...
"top"!==b.align&&"bottom"!==b.align||(b.align="left");"left"!==b.placement&&"right"!==b.placement||"left"!==b.align&&"right"!==b.align||(b.align="top");f.addClass(b.placement);f.addClass("clockpicker-align-"+b.align);this.spanHours.click(l.proxy(this.toggleView,this,"hours"));this.spanMinutes.click(l.proxy(this.toggleView,this,"minutes"));k.on("focus.clockpicker click.clockpicker",l.proxy(this.show,this));d.on("click.clockpicker",l.proxy(this.toggle,this));var m=l('<div class="clockpicker-tick"></div>'),
t;if(b.twelvehour)for(c=1;13>c;c+=1)k=m.clone(),d=c/6*Math.PI,t=80,k.css("font-size","120%"),k.css({left:100+Math.sin(d)*t-13,top:100-Math.cos(d)*t-13}),k.html(0===c?"00":c),h.append(k),k.on(x,e);else for(c=0;24>c;c+=1){var k=m.clone(),d=c/6*Math.PI,u=0<c&&13>c;t=u?54:80;k.css({left:100+Math.sin(d)*t-13,top:100-Math.cos(d)*t-13});u&&k.css("font-size","120%");k.html(0===c?"00":c);h.append(k);k.on(x,e)}for(c=0;60>c;c+=5)k=m.clone(),d=c/30*Math.PI,k.css({left:100+80*Math.sin(d)-13,top:100-80*Math.cos(d)-
13}),k.css("font-size","120%"),k.html(r(c)),g.append(k),k.on(x,e);v.on(x,function(a){0===l(a.target).closest(".clockpicker-tick").length&&e(a,!0)});if(w){var C=f.find(".clockpicker-canvas"),f=document.createElementNS("http://www.w3.org/2000/svg","svg");f.setAttribute("class","clockpicker-svg");f.setAttribute("width",200);f.setAttribute("height",200);h=document.createElementNS("http://www.w3.org/2000/svg","g");h.setAttribute("transform","translate(100,100)");g=document.createElementNS("http://www.w3.org/2000/svg",
...
3.5);h.appendChild(m);h.appendChild(c);h.appendChild(k);h.appendChild(g);f.appendChild(h);C.append(f);this.hand=m;this.bg=c;this.fg=k;this.bearing=g;this.g=h;this.canvas=C}p(this.options.init)}function p(a){a&&"function"===typeof a&&a()}var l=window.jQuery,D=l(window),q=l(document),y,w="SVGAngle"in window&&function(){var a,b=document.createElement("div");b.innerHTML="<svg/>";a="http://www.w3.org/2000/svg"==(b.firstChild&&b.firstChild.namespaceURI);b.innerHTML="";return a}(),H=function(){var a=document.createElement("div").style;
return"transition"in a||"WebkitTransition"in a||"MozTransition"in a||"msTransition"in a||"OTransition"in a}(),u="ontouchstart"in window,x="mousedown"+(u?" touchstart":""),z="mousemove.clockpicker"+(u?" touchmove.clockpicker":""),A="mouseup.clockpicker"+(u?" touchend.clockpicker":""),E=navigator.vibrate?"vibrate":navigator.webkitVibrate?"webkitVibrate":null,G=0,B=H?350:1;d.DEFAULTS={"default":"",fromnow:0,placement:"bottom",align:"left",donetext:"\u5b8c\u6210",autoclose:!1,twelvehour:!1,vibrate:!0};
d.prototype.toggle=function(){this[this.isShown?"hide":"show"]()};d.prototype.locate=function(){var a=this.element,b=this.popover,e=a.offset(),f=a.outerWidth(),a=a.outerHeight(),d=this.options.placement,h=this.options.align,g={};b.show();switch(d){case "bottom":g.top=e.top+a;break;case "right":g.left=e.left+f;break;case "top":g.top=e.top-b.outerHeight();break;case "left":g.left=e.left-b.outerWidth()}switch(h){case "left":g.left=e.left;break;case "right":g.left=e.left+f-b.outerWidth();break;case "top":g.top=
...
h.addClass("clockpicker-dial-out");d.css("visibility","visible").removeClass("clockpicker-dial-out");this.resetClock(b);clearTimeout(this.toggleViewTimer);this.toggleViewTimer=setTimeout(function(){h.css("visibility","hidden")},B);e&&p(this.options.afterHourSelect)};d.prototype.resetClock=function(a){var b=this.currentView,e=this[b],f="hours"===b,b=Math.PI/(f?6:30)*e,e=f&&0<e&&13>e?54:80,d=Math.sin(b)*e,h=-Math.cos(b)*e,g=this;w&&a?(g.canvas.addClass("clockpicker-canvas-out"),setTimeout(function(){g.canvas.removeClass("clockpicker-canvas-out");
g.setHand(d,h)},a)):this.setHand(d,h)};d.prototype.setHand=function(a,b,e,f){var d=Math.atan2(a,-b),h="hours"===this.currentView,g=Math.PI/(h||e?6:30);b=Math.sqrt(a*a+b*b);a=this.options;var m=h&&67>b;b=m?54:80;var c;a.twelvehour&&(b=80);0>d&&(d=2*Math.PI+d);c=Math.round(d/g);d=c*g;a.twelvehour?h?0===c&&(c=12):(e&&(c*=5),60===c&&(c=0)):h?(12===c&&(c=0),c=m?0===c?12:c:0===c?0:c+12):(e&&(c*=5),60===c&&(c=0));this[this.currentView]!==c&&E&&this.options.vibrate&&!this.vibrateTimer&&(navigator[E](10),
