(function(){var h=[].slice;(function(d,f){var g;g=function(){function c(a,b){null==b&&(b={});this.$element=d(a);this.options=d.extend({},d.fn.bootstrapSwitch.defaults,{state:this.$element.is(":checked"),size:this.$element.data("size"),animate:this.$element.data("animate"),disabled:this.$element.is(":disabled"),readonly:this.$element.is("[readonly]"),indeterminate:this.$element.data("indeterminate"),inverse:this.$element.data("inverse"),radioAllOff:this.$element.data("radio-all-off"),onColor:this.$element.data("on-color"),
offColor:this.$element.data("off-color"),onText:this.$element.data("on-text"),offText:this.$element.data("off-text"),labelText:this.$element.data("label-text"),handleWidth:this.$element.data("handle-width"),labelWidth:this.$element.data("label-width"),baseClass:this.$element.data("base-class"),wrapperClass:this.$element.data("wrapper-class")},b);this.prevOptions={};this.$wrapper=d("<div>",{"class":function(a){return function(){var b;b=[""+a.options.baseClass].concat(a._getClasses(a.options.wrapperClass));
...
this._labelWidth)};c.prototype._containerPosition=function(a,b){null==a&&(a=this.options.state);this.$container.css("margin-left",function(b){return function(){var c;c=[0,"-"+b._handleWidth+"px"];return b.options.indeterminate?"-"+b._handleWidth/2+"px":a?b.options.inverse?c[1]:c[0]:b.options.inverse?c[0]:c[1]}}(this));if(b)return setTimeout(function(){return b()},50)};c.prototype._init=function(){var a,b;a=function(a){return function(){a.setPrevOptions();a._width();return a._containerPosition(null,
...
a.options.animate&&a.$wrapper.addClass(a.options.baseClass+"-animate"),a._dragEnd?(b=a._dragEnd>-(a._handleWidth/2),a._dragEnd=!1,a.state(a.options.inverse?!b:b)):a.state(!a.options.state),a._dragStart=!1}}(this),"mouseleave.bootstrapSwitch":function(a){return function(b){return a.$label.trigger("mouseup.bootstrapSwitch")}}(this)})};c.prototype._externalLabelHandler=function(){var a;a=this.$element.closest("label");return a.on("click",function(b){return function(c){c.preventDefault();c.stopImmediatePropagation();
if(c.target===a[0])return b.toggleState()}}(this))};c.prototype._formHandler=function(){var a;a=this.$element.closest("form");if(!a.data("bootstrap-switch"))return a.on("reset.bootstrapSwitch",function(){return f.setTimeout(function(){return a.find("input").filter(function(){return d(this).data("bootstrap-switch")}).each(function(){return d(this).bootstrapSwitch("state",this.checked)})},1)}).data("bootstrap-switch",!0)};c.prototype._getClasses=function(a){var b,c,e,f;if(!d.isArray(a))return[this.options.baseClass+
"-"+a];c=[];e=0;for(f=a.length;e<f;e++)b=a[e],c.push(this.options.baseClass+"-"+b);return c};return c}();d.fn.bootstrapSwitch=function(){var c,a,b;a=arguments[0];c=2<=arguments.length?h.call(arguments,1):[];b=this;this.each(function(){var f,e;f=d(this);(e=f.data("bootstrap-switch"))||f.data("bootstrap-switch",e=new g(this,a));if("string"===typeof a)return b=e[a].apply(e,c)});return b};d.fn.bootstrapSwitch.Constructor=g;return d.fn.bootstrapSwitch.defaults={state:!0,size:null,animate:!0,disabled:!1,
