...
isDSTShifted:function(){return this._a?this.isValid()&&0<ia(this._a,(this._isUTC?d.utc(this._a):d(this._a)).toArray()):!1},parsingFlags:function(){return x({},this._pf)},invalidAt:function(){return this._pf.overflow},utc:function(a){return this.zone(0,a)},local:function(a){this._isUTC&&(this.zone(0,a),this._isUTC=!1,a&&this.add(this._dateTzOffset(),"m"));return this},format:function(a){a=N(this,a||d.defaultFormat);return"Invalid date"==a?"TBC":this.localeData().postformat(a)},add:da(1,"add"),subtract:da(-1,
"subtract"),diff:function(a,b,c){a=F(a,this);var e=6E4*(this.zone()-a.zone()),g,f;b=m(b);"year"===b||"month"===b?(g=432E5*(this.daysInMonth()+a.daysInMonth()),e=12*(this.year()-a.year())+(this.month()-a.month()),f=this-d(this).startOf("month")-(a-d(a).startOf("month")),f-=6E4*(this.zone()-d(this).startOf("month").zone()-(a.zone()-d(a).startOf("month").zone())),e+=f/g,"year"===b&&(e/=12)):(g=this-a,e="second"===b?g/1E3:"minute"===b?g/6E4:"hour"===b?g/36E5:"day"===b?(g-e)/864E5:"week"===b?(g-e)/6048E5:
g);return c?e:r(e)},from:function(a,b){return d.duration({to:this,from:a}).locale(this.locale()).humanize(!b)},fromNow:function(a){return this.from(d(),a)},calendar:function(a){a=a||d();a=F(a,this).startOf("day");a=this.diff(a,"days",!0);a=-6>a?"sameElse":-1>a?"lastWeek":0>a?"lastDay":1>a?"sameDay":2>a?"nextDay":7>a?"nextWeek":"sameElse";return this.format(this.localeData().calendar(a,this))},isLeapYear:function(){return M(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||
...
b:"millisecond");return"millisecond"===b?(a=d.isMoment(a)?a:d(a),+this<+a):+this.clone().startOf(b)<+d(a).startOf(b)},isSame:function(a,b){b=m(b||"millisecond");return"millisecond"===b?(a=d.isMoment(a)?a:d(a),+this===+a):+this.clone().startOf(b)===+F(a,this).startOf(b)},min:q("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548",function(a){a=d.apply(null,arguments);return a<this?this:a}),max:q("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548",
